          ...
          {sections.map((section, index) => {
            return (
              ...
              >
                ...
                <img
                  className={
                    isLoaded[section.category]
                      ? "object-contain max-w-sm px-8 py-4"
                      : "hidden"
                  }
                  onLoad={() => {
                    setIsLoaded((prevStates) => ({
                      ...prevStates,
                ...
                <svg
                  ...
                  className={
                    isLoaded[section.category]
                      ? "hidden"
                      : "inline w-1/2 h-1/2 p-10 text-gray-200 animate-spin dark:text-gray-600 fill-green-500"
                  }
                  viewBox="0 0 100 101"
                  fill="none"
