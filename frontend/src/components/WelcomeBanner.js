      ...
      <div className="flex flex-col justify-center items-center px-12">
        <div className="p-2 relative max-w-4xl min-w-md flex justify-center rounded-2xl bg-green-900">
          <img
            ...
            alt={"Car"}
            className={isLoaded ? "rounded-xl" : "hidden"}
          ...
          <svg
            ...
            className={
              isLoaded
                ? "hidden"
                : "inline w-full h-full text-gray-200 animate-spin dark:text-gray-600 fill-green-500"
            }
            viewBox="0 0 100 101"
            fill="none"
          ...
          <div
            className={
              isLoaded
                ? "p-4 absolute top-1/3 font-bebas text-2xl text-white sm:text-5xl md:text-6xl lg:text-7xl text-nowrap"
                : "hidden"
            }
          >
